...
DO:
1. Write 8-12 panels to `workspace/phase-038/panels.json` as list of
...
5. Then run: `python3 scripts/render.py phase-038` and `python3 scripts/judge.py phase-038`.
