...
## Step 2 — write workspace/phase-010/panels.json
...
Run: `python3 scripts/render.py phase-010` then `python3 scripts/judge.py phase-010`.
If judge reports a panel needs retry, DO NOT just bump the seed and hope — use
`python3 scripts/render.py fix phase-010 <panel_id> "<specific correction, e.g.
