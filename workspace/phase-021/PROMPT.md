...
DO:
1. Write 8-12 panels to `workspace/phase-021/panels.json` as list of
...
5. Then run: `python3 scripts/render.py phase-021` and `python3 scripts/judge.py phase-021`.
