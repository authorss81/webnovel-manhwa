...
DO:
1. Write 8-12 panels to `workspace/phase-054/panels.json` as list of
...
5. Then run: `python3 scripts/render.py phase-054` and `python3 scripts/judge.py phase-054`.
